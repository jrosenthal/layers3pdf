...
public class Layers3PDF
{
  ...
  public void process()
  {
    ...
    String[] template_keys = { "path", "title", "author", "subject", "user_pass", "owner_pass", "keywords", "fix_coords" };
    ...
    try 
    {
      ...
      ByteBuffer.HIGH_PRECISION = true; // needed for geo-referencing
                  
      // read the ini file
      int layer_count = 0;
      String fix_coords = null;
      int base_rotation = 0;
      ...
      while( true )
      {
        ...
        if( layer_count++ == 0 )
        {
          ...
          fix_coords = template_info.get( "fix_coords" );
          if( fix_coords == null )
            fix_coords = "1";
          ...
          Rectangle size = base.getPageSizeWithRotation(1);
          document = new Document( size );
          writer = PdfWriter.getInstance( document, 
                                          new FileOutputStream( args[arg_start+1] ) );
          base_rotation = base.getPageRotation( 1 );
          base_height = size.getHeight();
        ...
        // add fix_coords in there too
        if( fix_coords != null )
        {
          layer_info.put( "fix_coords", fix_coords );
          layer_info.put( "base_rotation", Integer.toString( base_rotation ) );
          layer_info.put( "base_height", Double.toString( base_height ) );
        }
